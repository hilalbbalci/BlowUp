...
# file49 = URI.open("")
# file50 = URI.open("")
photo1 = Photo.new(title: "Flower Girl", description: "Amazing beatiful girl scatters flowers in Hawaii wedding", user_id: diane.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/flowergirl.jpeg" )
photo2 = Photo.new(title: "Have fun with a child", description: "A child can make you happiest person ever", user_id: robert.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/annekiz.jpeg")
photo3 = Photo.new(title: "Balcony", description: "Dream the most beatiful view you can have", user_id: annie.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/balkon.jpeg")
photo4 = Photo.new(title: "Bicycle", description: "Authentic street with a beatiful bicycle", user_id: steve.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/bisikletlisokak.jpeg")
photo5 = Photo.new(title: "The boat", description: "I know some boats which are far away from the shores", user_id: diane.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/bot.jpeg")
photo6 = Photo.new(title: "Lake", description: "A frozen lake is the best part of the vaccation", user_id: alfred.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/buzlugol.jpeg")
photo7 = Photo.new(title: "Glass Face", description: "Somebody knows to hide the feelings", user_id: irving.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/camdansurat.jpeg")
photo8 = Photo.new(title: "A Egg", description: "Needs care:)", user_id: edward.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/catlakyumurta.jpeg")
photo9 = Photo.new(title: "Broken lands", description: "Harmony of yellow and land color", user_id: cindy.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/catlamistopraklar.jpeg")
photo10 = Photo.new(title: "Tea", description: "A cup of tea is the best", user_id: diane.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/cay.jpeg")
photo11 = Photo.new(title: "Diver", description: "Above and below the sea", user_id: robert.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/dalgic.jpeg")
photo12 = Photo.new(title: "Sea", description: "Enjoy with the view!", user_id: cindy.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/deniz.jpeg")
photo13 = Photo.new(title: "Jellyfish", description: "Amazing world inside", user_id: cindy.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/denizanasi.jpeg")
photo14 = Photo.new(title: "Sunset", description: "Having fun at sunset", user_id: alfred.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/donmedolap.jpeg")
photo15 = Photo.new(title: "Tattoo", description: "Express yourself in a different way", user_id: jazz.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/dovmeliadam.jpeg")
photo16 = Photo.new(title: "Pry", description: "Sometimes, all you need is faith", user_id: drew.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/dua.jpeg")
photo17 = Photo.new(title: "Boxer", description: "A strong punch is coming", user_id: amy.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/boksor.jpeg")
photo18 = Photo.new(title: "High", description: 'You want to touch the clouds', user_id: kate.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/dumanli+kayalar.jpeg")
photo19 = Photo.new(title: "Ice", description: "Resist melting", user_id: john.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/erimis+buzullar.jpeg")
photo20 = Photo.new(title: "Red Flowers", description: "lying on a flower bed", user_id: alfred.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/gelincikler+icin.jpeg")
photo21 = Photo.new(title: "Color of a Rose", description: "Have you ever look at a rose this closely", user_id: jazz.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/gul.jpeg")
photo22 = Photo.new(title: "Family", description: "A family in a shot, while laughing and having fun", user_id: amy.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/guzelbiraile.jpeg")
photo23 = Photo.new(title: "Rugs", description: "Handcraft rugs are waiting for somebody who knows their value", user_id: jazz.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/halilar.jpeg")
photo24 = Photo.new(title: "Wind Chimes", description: "feel the enchanting melody", user_id: annie.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/hediyelikesya.jpeg")
photo25 = Photo.new(title: "An Interesting Window", description: "Some beauties are hidden, you need to find them", user_id: kate.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/ilgincpencere.jpeg")
photo26 = Photo.new(title: "Etry Image", description: "Some beauties are hidden, you need to find them", user_id: kate.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/entryPhoto.jpeg")
photo27 = Photo.new(title: "Yoga", description: "Mental health", user_id: annie.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/yogayapankadin.jpeg")
photo28 = Photo.new(title: "Big Shoes", description: "Under the shoes", user_id: amy.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/ayakkabilikiz.jpeg")
photo29 = Photo.new(title: "Lights", description: "Some beauties", user_id: robert.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/isiklar.jpeg")
photo30 = Photo.new(title: "On the Beach", description: "Have some rest and enjoy with sun", user_id: irving.id, post: "https://blowup-dev.s3.us-west-1.amazonaws.com/sapka.jpeg")
